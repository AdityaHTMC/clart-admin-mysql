    ...
    if (orderDetails) {
      setInputData({
        ...
        shipping_address: {
            ...
            address_line_1: orderDetails.data.shipping_address?.address_line_1 || "",
            address_line_2: orderDetails.data.shipping_address?.address_line_2 || "",
        },
        billing_address: {
            ...
            address_line_1: orderDetails.data.billing_address?.address_line_1 || "",
            address_line_2: orderDetails.data.billing_address?.address_line_2 || "",
        }
  ...
  const formatDate = (date) => {
    ...
    const handleInputChange = (e) => {
      ...
      const handleItemChange = async (index, field, value) => {
        ...
        if (field === "breed_id" || field === "quantity" || field === "unit_price") {
          ...
          if ((field === "breed_id" || field === "quantity") && animal && quantity > 0) {
            getpackingBox(animal.id, quantity).then((res) => {
              updatedItems[index].packing_box_capacity = res?.expected_quantity;
      ...
      const addItemRow = () => {
        setOrderItems([
          ...orderItems,
          { breed_id: "", quantity: 1, unit_price:1, packing_box_capacity: "", total_price: 0 },
        ]);
      };
      ...
      const handleSubmit = () => {
        const items = orderItems.map((item) => ({
          ...
          packing_box_quantity: parseInt(item.packing_box_capacity, 10),
                ...
                {orderItems.map((item, index) => (
                  <div className="row" key={index}>
                    ...
                    <FormGroup className="col-md-2">
                      ...
                      <Input
                        type="text"
                        value={item.packing_box_capacity}
